...
| Field | Details |
|---|---|
| **Name** | Sonakshi Dashore |
| **Roll Number** | 24BCY10243 |
| **Repository** | `oss-audit-24BCY10243` |
...
```bash
git clone https://github.com/<sonakshi0604>/oss-audit-24BCY10243.git
cd oss-audit-24BCY10243
```
